...
import { Check, Crown, TrendingUp, Users, Lock, BarChart3, Mail, Target, Zap, Activity, Award, Eye, FileText, Calendar } from "lucide-react"
...
const exclusiveContent = [
  {
    ...
    description: "Análisis predictivo completo de cada partido con probabilidades, xG esperado, zonas de peligro y tendencias históricas",
    image: "https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=800&h=400&fit=crop",
    link: "/partido/preview/sample"
  },
  {
    title: "Post-Partidos Profundos",
    description: "Desglose completo con evolución del xG minuto a minuto, mapas de calor por jugador y análisis de momentos clave",
  ...
  },
  {
    ...
    description: "Métricas avanzadas individuales, rendimiento por zona, comparativas con la competencia y proyecciones de temporada",
  ...
  },
  {
    ...
    description: "Estadísticas colectivas, patrones tácticos, fortalezas y debilidades, y comparativas con otros equipos de la liga",
  ...
  },
  {
    ...
    description: "Clasificaciones avanzadas basadas en métricas premium: xG Chain, PPDA, regates progresivos y mucho más",
    image: "https://images.unsplash.com/photo-1489944440615-453fc2b6a9a9?w=800&h=400&fit=crop",
    link: "/los-mas"
  },
  {
    title: "Reportes Semanales",
    description: "Resumen completo de la jornada con los mejores y peores rendimientos, sorpresas estadísticas y tendencias emergentes",
...
const faqs = [
  {
    ...
    answer: "Acceso completo a todos los análisis avanzados, mapas de calor, métricas premium, rankings exclusivos, newsletter avanzada y contenido reservado para miembros."
  },
  {
    question: "¿Puedo cancelar en cualquier momento?",
    answer: "Sí, esta es una demo gratuita sin compromiso. Puedes probar todas las funciones sin necesidad de tarjeta de crédito."
  },
  {
    question: "¿Con qué frecuencia se actualiza el contenido?",
    answer: "Publicamos análisis antes y después de cada partido de LaLiga, además de reportes semanales y rankings actualizados en tiempo real."
  },
  {
    question: "¿Los datos provienen de Opta?",
    answer: "Actualmente usamos datos de ejemplo. Próximamente integraremos datos oficiales de Opta para mayor precisión."
  },
  {
    question: "¿Necesito conocimientos previos de estadística?",
    answer: "No. Explicamos cada métrica en nuestro diccionario de datos y los análisis están escritos para ser comprensibles por cualquier aficionado."
  },
  {
    question: "¿Puedo compartir mi cuenta?",
    answer: "Las cuentas son personales. Ofrecemos planes familiares y de grupo para compartir el acceso de forma oficial."
  }
]
      ...
      <main>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-neutral-900 via-neutral-800 to-black py-20">
          <div className="container mx-auto px-4 text-center text-white">
            ...
            <p className="mx-auto mb-8 max-w-2xl text-xl text-neutral-300">
              Accede a análisis avanzados, métricas premium y contenido exclusivo 
              para entender el fútbol como nunca antes
            </p>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-sm text-neutral-400">
                Demo gratuita • Acceso inmediato • Sin tarjeta
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <h2 className="mb-4 text-center text-3xl font-bold">
            Todo lo que incluye LEGEND
          </h2>
          <p className="mx-auto mb-12 max-w-2xl text-center text-neutral-600">
            Más de 120 métricas exclusivas, análisis predictivos con IA y herramientas profesionales de visualización de datos
          </p>
          
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              <Card key={index} className="p-6 text-center transition-all hover:shadow-lg hover:border-[#d4af37]">
                <div className="mb-4 flex justify-center">
                  <div className="rounded-full bg-[#d4af37]/10 p-4 text-[#d4af37]">
                    {feature.icon}
                  </div>
                </div>
        ...
        {/* Exclusive Content Preview - NUEVA SECCIÓN AMPLIADA */}
        <div className="bg-neutral-50 py-16">
          <div className="container mx-auto px-4">
            <h2 className="mb-4 text-center text-3xl font-bold">
              Contenido Exclusivo LEGEND
            </h2>
            <p className="mx-auto mb-12 max-w-2xl text-center text-neutral-600">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {exclusiveContent.map((content, index) => (
                <Link key={index} href={content.link}>
                  <Card className="group overflow-hidden transition-all hover:shadow-xl hover:border-[#d4af37]">
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
              ...
              <Card className="overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  {/* Newsletter Section for Amateur */}
        ...
        {/* Testimonials - AMPLIADOS */}
        <div className="bg-neutral-50 py-16">
          <div className="container mx-auto px-4">
            <h2 className="mb-4 text-center text-3xl font-bold">
              Lo que dicen nuestros LEGEND
            </h2>
            <p className="mx-auto mb-12 max-w-2xl text-center text-neutral-600">
              ...
              <Card key={index} className="overflow-hidden">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-2xl text-[#d4af37] transition-transform ${faqOpen === index ? 'rotate-45' : ''}`}>
                      +
                    </span>
                  </div>
                  {faqOpen === index && (
          ...
          <Card className="overflow-hidden border-2 border-[#d4af37]">
            <div className="bg-gradient-to-br from-[#d4af37] to-[#b8941f] p-12 text-center text-white">
              ...
              <p className="mt-4 text-sm opacity-90">
                Demo gratuita • Acceso completo • Sin compromiso
              </p>
            </div>
          </Card>
        </div>
